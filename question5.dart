...
void main() {
  ...
  double managerTotalSalary =
      manager.calculateSalary(managerBaseSalary, managerBonus);

  double developerBaseSalary = developer.getBaseSalary();
  double developerBonus = 500.0;
  double developerTotalSalary =
      developer.calculateSalary(developerBaseSalary, developerBonus);
  ...
  print("Calculated Salary: ${managerTotalSalary}");
  manager.processPayment(managerTotalSalary);
  print(managerReport);
  print("");
  developer.displayInfo();
  print("Job Title: ${developer.getJobTitle()}");
  print("Base Salary: ${developerBaseSalary}");
  print("Calculated Salary: ${developerTotalSalary}");
